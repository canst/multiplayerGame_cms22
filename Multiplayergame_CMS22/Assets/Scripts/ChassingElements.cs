...
public class ChassingElements : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            flyingobject.GetComponent<Renderer>().material = chasingMaterial;
        ...
        flyingobject.GetComponent<Renderer>().material = idleMaterial;
